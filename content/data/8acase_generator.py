...
logo_scale = phone_x/2
logo_svg = input("Enter file name of svg file in current working directory (example: C-paw.svg)\n")
logo_path = os.path.join(os.getcwd(), logo_svg)
logo = import_svg(logo_path)
...
export_stl(phonecase.part, f"8acase_{logo_svg[0:-4]}.stl")
